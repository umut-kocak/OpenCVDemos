...
class ImageStitchingDemo(BaseVideoDemo):
    ...
    def stitch_images(self, images):
        ...
        def stitch_task():
            ...
            #stitched = self._stitcher.stitch_images(images, mode=cv2.Stitcher_SCANS)
    ...
    def register_keys(self):
        ...
        """
        super(ImageStitchingDemo, self).register_keys()
    ...
    def check_captured_frame(self, frame):
        ...
        frame_status = super(ImageStitchingDemo, self).check_captured_frame(frame)
